...
import { removeTrackFromPlaylist } from "../../api/api";
...
export default class Track extends Component {
  ...
  <div class="tracks__item__data flex"><span class="data__text">${formatDaysAgo(this.data.createdAt)} дней назад</span>
