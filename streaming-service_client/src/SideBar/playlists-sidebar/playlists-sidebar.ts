...
export default class PlaylistsSideBar extends Component {
      ...
      <nav class="aside__nav">
        ...
        <ul class="aside__list">
          <li class="aside__item">
            <button class="aside__btn aside__tabs-btn aside__btn-active" data-path="tracks">
          ...
          <li class="aside__item">
            <button class="aside__btn aside__tabs-btn" data-path="playlists">
  ...
  addEventListeners(): void {
    ...
    playlistsBtn?.addEventListener("click", () => {
      ...
      switchScreen(ScreenState.UserPlaylist, this.token, this.username);
    });
  }
}
